...
const ja: Dict = {
  ...
  "setup.title": "NAGIを設定しましょう",
  "setup.subtitle": "5つのステップで、AI受付がすぐに使えるようになります",
  "setup.next": "次へ",
  "setup.skip": "後で設定する",
  "setup.step.profile": "店舗情報",
  "setup.step.type": "業種",
  "setup.step.hours": "営業時間",
  "setup.step.services": "サービス",
  "setup.step.staff": "スタッフ",
  "setup.step.done": "完了",
  ...
  "setup.services.desc": "提供するメニューと価格・所要時間を確認・編集してください。",
  "setup.services.titleSeating": "予約メニュー・席を登録",
  "setup.services.descSeating":
    "お席やコースの予約枠を確認・編集してください。所要時間は滞在時間の目安です。",

  "setup.staff.title": "スタッフを登録",
  "setup.staff.desc": "対応スタッフ名を追加してください。",
  "setup.done.title": "NAGIの準備ができました",
  "setup.done.desc": "ダッシュボードからAI受付を試したり、実際の予約を受け付けたりできます。",
  "setup.done.cta": "ダッシュボードを開く",
  "setup.done.tryNagi": "NAGIを試す",
  "setup.done.summary": "サービス{s}件・スタッフ{p}名・週{d}日営業",
  "setup.progress.title": "セットアップの進捗",
  "setup.progress.desc": "NAGIがお客様対応できる状態にするための設定です。",
  "setup.progress.ready": "NAGIの準備が整っています",
  "setup.progress.readyDesc": "すべての基本設定が完了しています。",
  "setup.progress.profile": "店舗情報",
  "setup.progress.hours": "営業時間",
  "setup.progress.services": "サービス",
  "setup.progress.staff": "スタッフ",
  "setup.progress.cta": "続きを設定する",
  ...
  "recept.title": "AI受付",
  "recept.desc": "登録済みの店舗データをもとに、NAGIが実際のお客様対応を行います。",
  ...
  "recept.suggested": "よくあるご質問の例",
  "recept.ask.book": "予約したい",
  "recept.ask.price": "料金を知りたい",
  "recept.ask.hours": "営業時間は？",
  "recept.ask.tomorrow": "明日予約したい",
  "recept.ask.cancel": "キャンセルしたい",
  "recept.ask.staff": "スタッフと話したい",
  "recept.ask.colorStaff": "カラーは誰が担当できますか？",
  "recept.ask.unknown": "駐車場ありますか？",
...
const en: Dict = {
  ...
  "setup.title": "Set up NAGI",
  "setup.subtitle": "Complete 5 quick steps so NAGI can start answering customers",
  "setup.next": "Next",
  "setup.skip": "Set up later",
  "setup.step.profile": "Business",
  "setup.step.type": "Type",
  "setup.step.hours": "Hours",
  ...
  "setup.done.desc": "You can test the receptionist or start taking real bookings.",
  "setup.done.cta": "Open dashboard",
  "setup.done.tryNagi": "Try NAGI now",
  "setup.done.summary": "{s} services, {p} staff, open {d} days a week",
  "setup.progress.title": "Setup progress",
  "setup.progress.desc": "Complete these so NAGI can answer customers confidently.",
  "setup.progress.ready": "NAGI is fully set up",
  "setup.progress.readyDesc": "All required information is in place.",
  "setup.progress.profile": "Business profile",
  "setup.progress.hours": "Opening hours",
  "setup.progress.services": "Services",
  "setup.progress.staff": "Staff",
  "setup.progress.cta": "Continue setup",
  ...
  "recept.desc": "NAGI answers customers live, using your saved business data.",
  "recept.status": "Online — ready",
  "recept.clear": "Clear conversation",
  "recept.new": "Start a new conversation",
  ...
  "recept.suggested": "Example customer questions",
  "recept.ask.book": "I want to make an appointment",
  "recept.ask.price": "What's the price?",
  "recept.ask.hours": "What are your opening hours?",
  "recept.ask.tomorrow": "I want to book tomorrow",
  "recept.ask.cancel": "I want to cancel",
  "recept.ask.staff": "I want to speak with a staff member",
  "recept.ask.colorStaff": "Which staff can do a colour?",
  "recept.ask.unknown": "Do you have parking?",
